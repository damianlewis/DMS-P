...
@section('breadcrumbs')
    ...
    <li><a href="{{ route('deliveries.show', $drop->delivery->id) }}">Details</a></li>
...
@section('content')
    <div class="clearfix">
        ...
        @if($drop->drop_status_id == 1)
            <a href="#" data-reveal-id="cancelDropAlert" class="right button alert radius">Cancel drop</a>
        @endif
    </div>
    ...
    <div class="row">
        <div class="small-12 columns">
            <ul class="button-group radius">
                <li><a href="{{ route('drops.edit', $drop->id) }}" class="button small">Edit</a></li>
                <li><a href="{{ route('deliveries.show', $drop->delivery->id) }}" class="button small">Cancel</a></li>
            </ul>
        </div>
    </div>

    <div id="cancelDropAlert" class="reveal-modal actions" data-reveal>
        <h2>Alert</h2>
        <p>Are you sure that you want to cancel this delivery drop.</p>
        <a href="{{ route('drops.cancel', $drop->id) }}" class="right button small alert radius">Contine</a>
